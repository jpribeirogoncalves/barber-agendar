...
if (isset($_SESSION['usuario_id'])) {
    ...
    if ($result_user && $result_user->num_rows > 0) {
        ...
        // Trate o caso em que os dados do usuário não puderam ser obtidos
        // Isso pode incluir redirecionar para outra página ou exibir uma mensagem de erro
    }
}
?>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <a href="redefinir_senha.php" class="btn btn-warning mt-3">Redefinir senha</a>
            </div>
        </div>
    </div>

    <!-- Seu rodapé ou outros elementos comuns aqui -->
